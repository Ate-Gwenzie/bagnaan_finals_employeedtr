...
<style>
  ...
  .app-header .nav-links a.logout-link:hover {
...
<header class="app-header">
  <div class="brand"><img src="/emp_dtr/logo.png" alt="DTR Logo" class="brand-logo" /> <span>E-DTR SYSTEM</span></div>
  ...
  <nav class="nav-links" id="main-nav">
    ...
    <?php if (isset($_SESSION['admin_id'])): ?>
      ...
      ?>
      <a href="/emp_dtr/adminPage/adminMain.php">
        <svg class="icon-sm" style="margin-right: 4px;" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><rect x="3" y="3" width="7" height="9"/><rect x="14" y="3" width="7" height="5"/><rect x="14" y="12" width="7" height="9"/><rect x="3" y="16" width="7" height="5"/></svg>
        Admin Dashboard
      </a>
      <a href="/emp_dtr/adminPage/viewNotifications.php" title="Notifications">
        <svg class="icon-sm" style="margin-right: -4px;" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="M18 8A6 6 0 0 0 6 8c0 7-3 9-3 9h18s-3-2-3-9zm-1.87 11a2 2 0 1 1-3.48 0"/></svg>
        <?php echo $unread > 0 ? "<span class=\"notif-count\">" . intval($unread) . "</span>" : ''; ?>
      </a>
      <a href="/emp_dtr/user/logout.php" class="logout-link">
        <svg class="icon-sm" style="margin-right: 4px;" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="M9 21H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h4"/><polyline points="16 17 21 12 16 7"/><line x1="21" y1="12" x2="9" y2="12"/></svg>
        Logout
      </a>
    <?php elseif (isset($_SESSION['employee_id'])): ?>
      ...
      ?>
      <a href="/emp_dtr/employeePage/mainpage.php">
        <svg class="icon-sm" style="margin-right: 4px;" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><circle cx="12" cy="12" r="10"/><polyline points="12 6 12 12 16 14"/></svg>
        My DTR
      </a>
