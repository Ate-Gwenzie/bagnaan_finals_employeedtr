...
require_once '../includes/header_admin.php'; // Assuming a header_admin.php exists
...
if (!$notification) {
    ...
    header("Location: viewNotifications.php?error=invalid_notification");
    exit();
}
...
<div class="app-container">
    <div class="card notification-detail-card">
        ...
        <div class="card-body">
            ...
            <a href="viewNotifications.php" class="btn btn-secondary mt-4">← Back to All Notifications</a>
        </div>
    </div>
</div>
